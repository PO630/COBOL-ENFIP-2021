      ...
      ******************************************************************
       ...
       PROGRAM-ID. 6-EXONERES.
       ENVIRONMENT DIVISION.
       INPUT-OUTPUT SECTION.
       FILE-CONTROL.

           SELECT FE ASSIGN TO "6-exoneres.dat"
                   ORGANIZATION LINE SEQUENTIAL.

           SELECT FS ASSIGN TO "7-exoneres.txt"
                   ORGANIZATION LINE SEQUENTIAL.
      ...
      *     05 FS-LINE PIC X(121).
      *     05 FS-TITRE PIC X(30) VALUE 'Liste des exoneres :'.
      *
      *     05 FS-TABLEAU.
      ...
      *             15 FILLER PIC X VALUE '|'.
      *         10 COLONNES-VALUES.
      *             15 Valeur-tot PIC Z(9)9.99.
      *             15 FILLER PIC X VALUE '|'.
      *             15 Valeur-c PIC Z(9)9.99.
      *             15 FILLER PIC X VALUE '|'.
      *             15 Valeur-d PIC Z(9)9.99.
      *             15 FILLER PIC X VALUE '|'.
      *             15 Valeur-r PIC Z(9)9.99.
      *             15 FILLER PIC X VALUE '|'.
      ...
      *         10 FILLER PIC X VALUE '|'.
      *         10 FILLER PIC X(20) VALUE 'Nom Prénom'.
      *         10 FILLER PIC X VALUE '|'.
      ...
      *         10 FILLER PIC X VALUE '|'.
      *         10 FILLER PIC X(12) VALUE 'Dépt.'.
      *         10 FILLER PIC X VALUE '|'.
      *         10 FILLER PIC X(12) VALUE 'Région'.
      *         10 FILLER PIC X VALUE '|'.
      ...
      *             15 FILLER PIC X VALUE ':'.
      *             15 Total-fin PIC Z(12)9.99.
      *         10 Communes.
      *             15 FILLER PIC X(16) VALUE 'Communes'.
      *             15 FILLER PIC X VALUE ':'.
      *             15 Communes-fin PIC Z(12)9.99.
      *         10 Departements.
      *             15 FILLER PIC X(16) VALUE 'Departements'.
      *             15 FILLER PIC X VALUE ':'.
      *             15 Departements-fin PIC Z(12)9.99.
      *         10 Regions.
      *             15 FILLER PIC X(16) VALUE 'Regions'.
      *             15 FILLER PIC X VALUE ':'.
      *             15 Regions-fin PIC Z(12)9.99.
       ...
       01  Affichage.
           ...
           05 ARTICLE-INDIV.
               ...
               10 COLONNE-LIEU.
                   ...
                   15 FILLER PIC X VALUE '|'.
               10 COLONNES-VALUES.
                   15 Valeur-tot PIC Z(8)9.99.
                   15 FILLER PIC X VALUE '|'.
                   15 Valeur-c PIC Z(8)9.99.
                   15 FILLER PIC X VALUE '|'.
                   15 Valeur-d PIC Z(8)9.99.
                   15 FILLER PIC X VALUE '|'.
                   15 Valeur-r PIC Z(8)9.99.
                   15 FILLER PIC X VALUE '|'.
                   15 Occurences PIC Z(5)9.
                   15 FILLER PIC X VALUE '|'.

           05 ARTICLE-TITRE PIC X(30) VALUE 'Liste des exoneres :'.
           ...
           PERFORM UNTIL FF
               READ FE
                   ...
                   INITIALIZE Lieu
                       ...
                       INTO Nom-Prenom
                       STRING E-Commune DELIMITED BY SPACE
                              ', ' DELIMITED BY SIZE
